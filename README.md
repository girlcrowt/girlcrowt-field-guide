...
The GQL is not built around memorizing technologies.

It is built around understanding them.

I want to know not only *how* something works, but *why* it works, what it depends on and where the same patterns appear again.
